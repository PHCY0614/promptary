...
const zhTW: Messages = {
  ...
  about: "關於",
  aboutIntro: [
    "Promptary 是用來收藏 AI 生圖咒語、來源網址和嘗試紀錄的小工具，方便集中整理與比較。",
  ],
  aboutSteps: [
    "點「新增」建立收藏，加入圖片與咒語（可以先存圖，後補字）。",
    "用搜尋和標籤找到收藏，一鍵複製咒語到生圖平台。",
    "生成後回到 Promptary，「新增嘗試」記錄成果圖、平台、模型、評分與心得。",
    "選兩張圖並排比較，看不同嘗試的效果，並比對各自的咒語。",
    "定期到「管理 → 匯出」備份，避免資料遺失，換裝置時也能匯入還原。",
  ],
  aboutReminderTitle: "使用前的小提醒",
  aboutReminder: [
    "Promptary 目前以本機儲存，沒有帳號跟雲端同步功能。",
    "你的收藏只會存在目前使用的瀏覽器和裝置裡。換裝置、換瀏覽器或清除瀏覽器資料時，收藏不會自動跟著過去，也可能被清除，因此建議定期備份。",
    "另外，不建議使用無痕或私密瀏覽模式，關閉視窗後資料可能會一起掰掰。",
  ],
  aboutWhyTitle: "為什麼做這個？",
  aboutWhy: [
    "常常在 Threads 看到有趣咒語就跑去試，但是！每當生出漂亮圖片，或是想找回咒語分享給別人時，就會很困擾。畢竟 Threads 的收藏功能真的很難用 ( •᷄⌓•᷅ )！好想要有地方可以把這些酷東西儲存起來方便查看。",
  ...
  localLibraryHint: "支援 JPG、PNG、WebP，每張圖片上限 10 MB，一次最多可選 10 張。",
...
const en: Messages = {
  ...
  aboutSteps: [
    ...
    "Use search and tags to find a collection, then copy the prompt straight into your image generator.",
    "After generating, come back to Promptary and add \"New Attempt\" to record the result images, platform, model, rating, and notes.",
    "Pick two images to compare side by side, see how the results differ, and compare the prompts used for each.",
    "Back up regularly via \"Manage → Export\" to avoid losing your data. You can also import a backup when moving to another device.",
  ],
  aboutReminderTitle: "A few notes before you start",
  aboutReminder: [
    "Promptary currently stores everything locally. There are no accounts or cloud sync.",    
    "Your collection only exists in the browser and device you are using. Switching devices or browsers, or clearing your browser data, may leave your collection behind or remove it, so regular backups are recommended.",
    "Incognito or private browsing is also not recommended. Your data may disappear when you close the window.",
  ],
  aboutWhyTitle: "Why did I make this?",
  aboutWhy: [
    "I keep seeing interesting prompts on Threads and running off to try them. But whenever I get a beautiful result, or want to find a prompt again to share with someone, it turns into a hassle. Threads’ bookmarks are just so hard to use ( •᷄⌓•᷅ )!",
    "I wanted somewhere I could keep all these cool things and actually find them again.",
  ...
  localLibraryHint: "JPG, PNG, WebP. Max 10 MB each, up to 10 images at a time.",
