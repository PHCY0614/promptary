...
const zhTW: Messages = {
  ...
  addFavorite: "加入最愛",
  removeFavorite: "取消最愛",
  loadingArchive: "正在載入本機收藏（首次開啟會搬移舊資料）……",
  ...
  errors: {
    ...
    backupZipTooLarge: "備份 ZIP 超過 500 MB，原有收藏未變更。",
    ...
    importZipTooLarge: "目前單份 ZIP 匯入上限為 500 MB，請選擇較小的備份。",
...
const en: Messages = {
  ...
  loadingArchive: "Loading local collections (first launch migrates old data)…",
  ...
  errors: {
    ...
    backupZipTooLarge: "Backup ZIP exceeds 500 MB. Existing collections are unchanged.",
    ...
    importZipTooLarge: "ZIP import is limited to 500 MB. Choose a smaller backup.",
