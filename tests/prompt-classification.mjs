...
console.log('PASS: bilingual categories, word boundaries, ambiguous/unknown fallback, weights and LoRA preservation, repeated fragments, empty input, source-bound overrides and React-controlled category dropdown');
