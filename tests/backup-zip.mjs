...
const collection = { id: 'collection-1', name: '測試', referenceImages: [ref], coverSource: { type: 'reference', imageId: ref.id }, originalPrompt: 'prompt', promptPending: false, tags: [], isFavorite: false, status: 'want', collectionNotes: '', attempts: [attempt], addedAt: '2026-09-09T00:00:00.000Z', updatedAt: '2026-09-09T00:00:00.000Z' };
